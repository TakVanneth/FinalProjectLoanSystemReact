...
import { faUser, faMoneyCheckDollar, faCreditCard, faCircleUser, faList, faHouse } from '@fortawesome/free-solid-svg-icons';
// import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
            ...
            >
              ...
              <div className="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                <ul className="nav flex-column">
                  ...
                  <li className="nav-item">
                    <a
                      ...
                      href="/Borrower"
                    >
                    <FontAwesomeIcon icon={faUser} className="bi" />
                      Borrower
                    </a>
                  </li>
                  <li className="nav-item">
                ...
                <ul className="nav flex-column mb-auto">
                  ...
                  <li className="nav-item">
                  <button onClick={handleLogout} className="btn nav-link d-flex align-items-center gap-2">
                      <svg className="bi">
